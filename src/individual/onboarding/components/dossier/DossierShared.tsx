...
export function StepHeader({
  ...
  return (
    <div className="sticky top-0 z-20 bg-surface/95 backdrop-blur-sm border-b border-ink/[0.06] px-5 py-3">      <div className="mx-auto max-w-[600px] flex items-center gap-4">
