      ...
      <div className="flex flex-col gap-2.5">
        {actions.map((a) => (
          <Link key={a.id} to={a.href} className="no-underline group">
            <div className={["flex items-center gap-3 px-4 py-3.5 rounded-xl border transition-all hover:shadow-sm", PRIORITY_STYLES[a.priority]].join(" ")}>
              <div className={["w-2.5 h-2.5 rounded-full flex-shrink-0", DOT_COLORS[a.priority]].join(" ")} />
