    ...
    return (
      <div className="min-h-screen bg-cream flex items-center justify-center p-6">
        <div className="bg-white rounded-2xl shadow-card p-10 max-w-md w-full text-center">
          ...
          <Link to="/institution" className="flex items-center justify-center gap-2 bg-ficium text-white font-bold py-3 px-6 rounded-xl hover:bg-ficium-deep transition-colors">
