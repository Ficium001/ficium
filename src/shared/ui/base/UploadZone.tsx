    ...
    <label htmlFor={inputId} className={[
      ...
      <div className="flex items-start gap-3">
        ...
        <div className="min-w-0 flex-1">
          ...
          {/* Camera captures often generate very long numeric filenames —
              show a short friendly confirmation instead, not the raw name. */}
          {file && <div className="mt-2 text-xs font-medium text-ink/80">✓ Photo uploaded ({humanFileSize(file.size)})</div>}
        </div>
      </div>
