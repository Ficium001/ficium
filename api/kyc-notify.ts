    ...
    <tr><td align="center">
      <table width="520" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:20px;overflow:hidden;box-shadow:0 12px 30px rgba(10,10,26,0.08);">
        ...
        <tr><td style="padding:40px;">
          <h1 style="margin:0 0 12px;font-size:26px;font-weight:800;color:#0A0A1A;">Identity verified ✓</h1>
          ...
          <a href="https://ficium.vercel.app/requests/new" style="display:inline-block;background:#2A1FE6;color:#ffffff;font-weight:700;font-size:15px;padding:14px 28px;border-radius:12px;text-decoration:none;">
            Post your first request →
          </a>
        </td></tr>
        <tr><td style="padding:20px 40px 32px;border-top:1px solid rgba(10,10,26,0.07);">
          <p style="margin:0;font-size:12px;color:#6B6B85;">Questions? Visit <a href="https://ficium.vercel.app" style="color:#2A1FE6;">ficium.vercel.app</a></p>
        </td></tr>
      </table>
    </td></tr>
  </table>
  ...
  <table width="100%" cellpadding="0" cellspacing="0" style="background:#FAF7F0;padding:40px 20px;">
    <tr><td align="center">
      <table width="520" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:20px;overflow:hidden;box-shadow:0 12px 30px rgba(10,10,26,0.08);">
        ...
        <tr><td style="padding:40px;">
          <h1 style="margin:0 0 12px;font-size:26px;font-weight:800;color:#0A0A1A;">Identity verification unsuccessful</h1>
          <p style="margin:0 0 20px;font-size:15px;color:#6B6B85;line-height:1.6;">
          ...
          <p style="margin:0 0 24px;font-size:14px;color:#6B6B85;line-height:1.6;">
            You can resubmit with clearer photos. Make sure your ID is fully visible, in good lighting, and your selfie is a live photo.
          </p>
          <a href="https://ficium.vercel.app/onboarding/kyc" style="display:inline-block;background:#2A1FE6;color:#ffffff;font-weight:700;font-size:15px;padding:14px 28px;border-radius:12px;text-decoration:none;">
            Resubmit documents →
          </a>
        </td></tr>
        <tr><td style="padding:20px 40px 32px;border-top:1px solid rgba(10,10,26,0.07);">
          <p style="margin:0;font-size:12px;color:#6B6B85;">Need help? Reply to this email and our team will assist you.</p>
        </td></tr>
      </table>
    </td></tr>
  </table>
...
export default async function handler(req: any, res: any) {
  ...
  // Fetch user from Supabase REST API directly (no SDK needed)
  ...
  if (!userRes.ok) {
    return res.status(502).json({ error: "Failed to fetch user from database" });
  }
